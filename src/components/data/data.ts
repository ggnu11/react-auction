...
export const popularProductData = [
  ...
  { id: 2, name: 'Product 2', description: 'Description for product 1', image: Product2 },
  { id: 3, name: 'Product 3', description: 'Description for product 1', image: Product3 },
  { id: 4, name: 'Product 4', description: 'Description for product 1', image: Product4 },
  { id: 5, name: 'Product 5', description: 'Description for product 1', image: Product5 },
];
...
export const categoryData = [
  ...
  { id: 4, name: 'Home & Garden', image: homeAppliances },
  { id: 5, name: 'Sports', image: Sports },
  { id: 6, name: 'Toys', image: Toys },
